...
class BookingSeederLocation1 extends Seeder
{
    ...
    private function createBookings(int $locationId, array $guests): void
    {
        ...
        CheckIn::create(['booking_id' => $b1->id, 'room_id' => 1, 'checked_in_at' => now()->subDays(60)->setTime(14, 0), 'id_verified' => true]);
        CheckOut::create(['booking_id' => $b1->id, 'room_id' => 1, 'checked_out_at' => now()->subDays(53)->setTime(11, 0), 'room_condition' => 'good']);
        ...
        CheckIn::create(['booking_id' => $b2->id, 'room_id' => 1, 'checked_in_at' => now()->subDays(4)->setTime(14, 0), 'id_verified' => true]);
        ...
        CheckIn::create(['booking_id' => $b4->id, 'room_id' => 3, 'checked_in_at' => now()->subDays(30)->setTime(14, 0), 'id_verified' => true]);
        CheckOut::create(['booking_id' => $b4->id, 'room_id' => 3, 'checked_out_at' => now()->subDays(23)->setTime(11, 0), 'room_condition' => 'good']);
        ...
        CheckIn::create(['booking_id' => $b5->id, 'room_id' => 3, 'checked_in_at' => now()->subDays(3)->setTime(14, 0), 'id_verified' => true]);
