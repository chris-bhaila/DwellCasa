...
Route::get('/admin/room_type/index', function (\App\Contracts\RoomTypeRepositoryInterface $roomTypeRepository) {
...
Route::get('/admin/room-types/create', function () {
...
Route::get('/admin/room-types/{id}', function ($id, \App\Contracts\RoomTypeRepositoryInterface $roomTypeRepository) {
...
Route::get('/admin/room_type/room/add-room', function (\App\Contracts\AmenityRepositoryInterface $amenityRepository) {
...
Route::get('/admin/room_type/room/{id}/edit', function ($id, \App\Contracts\AmenityRepositoryInterface $amenityRepository) {
...
Route::get('/admin/bookings/{id}/edit', function ($id, \App\Contracts\RoomTypeRepositoryInterface $roomTypeRepository) {
...
Route::get('/admin/bookings/bookings', function (\App\Contracts\BookingRepositoryInterface $bookingRepository, \App\Contracts\RoomTypeRepositoryInterface $roomTypeRepository) {
    $bookings = $bookingRepository->all();
    $roomTypes = $roomTypeRepository->all();
    return view('admin.bookings.bookings', compact('bookings', 'roomTypes'));
})->name('admin.bookings');

Route::get('/admin/amenities', function (\App\Contracts\AmenityRepositoryInterface $amenityRepository) {
    $amenities = $amenityRepository->all();
