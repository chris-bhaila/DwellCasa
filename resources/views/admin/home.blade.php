...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            ...
            <h3 class="text-slate-500 text-sm font-medium">Available Rooms</h3>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm divide-y divide-slate-100">
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="p-4">
                                <p class="font-medium text-slate-900">Sarah Jenkins</p>
                                <p class="text-slate-500 text-xs">sarah@example.com</p>
                            </td>
                            <td class="p-4 text-slate-700">Executive Suite</td>
                            <td class="p-4 text-slate-700">
                                <p>Oct 12, 2024</p>
                                <p class="text-xs text-slate-400">Oct 15, 2024</p>
                            </td>
                            <td class="p-4">
                            ...
                            <td class="p-4 font-medium text-slate-900">Rs. 45,000</td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="p-4">
                                <p class="font-medium text-slate-900">Michael Chen</p>
                                <p class="text-slate-500 text-xs">michael.c@example.com</p>
                            </td>
                            <td class="p-4 text-slate-700">Deluxe Room</td>
                            <td class="p-4 text-slate-700">
                                <p>Oct 14, 2024</p>
                                <p class="text-xs text-slate-400">Oct 20, 2024</p>
                            </td>
                            <td class="p-4">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">Pending</span>
                            </td>
                            <td class="p-4 font-medium text-slate-900">Rs. 60,000</td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="p-4">
                                <p class="font-medium text-slate-900">Emma Watson</p>
                                <p class="text-slate-500 text-xs">emma@example.com</p>
                            </td>
                            <td class="p-4 text-slate-700">Presidential Suite</td>
                            <td class="p-4 text-slate-700">
                                <p>Oct 10, 2024</p>
                                <p class="text-xs text-slate-400">Oct 12, 2024</p>
                            </td>
                            <td class="p-4">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">Checked In</span>
                            </td>
                            <td class="p-4 font-medium text-slate-900">Rs. 70,000</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            <span class="text-slate-600">Executive Suites</span>
                            <span class="font-medium text-slate-900">8/10</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-2">
                            <div class="bg-[#A89070] h-2 rounded-full" style="width: 80%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            <span class="text-slate-600">Deluxe Rooms</span>
                    ...
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            <span class="text-slate-600">Presidential Suite</span>
                            <span class="font-medium text-slate-900">1/2</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-2">
