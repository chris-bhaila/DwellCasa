...
<head>
    ...
    <style>
        ...
        .message { color: #64748b; line-height: 1.7; margin-bottom: 32px; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p class="message">
                Thank you for choosing DwellCasa. Your booking request has been received and is currently being reviewed. 
